...
<main>
  ...
  <div class='main'>
    ...
    <div class='tools'>
      ...
      <a id='download'>  <button class='btn btn-default active-color-button display'><span class='glyphicon glyphicon-floppy-disk' aria-hidden='true'></span></button> </a>
      ...
      <div class='dropup display'>
        ...
        <ul class='dropdown-menu' style='padding: 0px' aria-labelledby='dropdownMenu'>
          <div id='panel'>
